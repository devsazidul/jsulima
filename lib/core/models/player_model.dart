class PlayerModel {
  // Updated to accept a defaultImage parameter for fallback
  static List<Map<String, dynamic>> mapPlayersToTeam(
    ...
    return players.asMap().entries.map((entry) {
      ...
      if (player['passing_touchdowns_used'] != null) {
        stats.add({
          'value':
              (player['passing_touchdowns_used'] as num).toInt().toString(),
      ...
      if (player['rushing_touchdowns_used'] != null) {
        stats.add({
          'value':
              (player['rushing_touchdowns_used'] as num).toInt().toString(),
      ...
      if (player['receiving_touchdowns_used'] != null) {
        stats.add({
          'value':
              (player['receiving_touchdowns_used'] as num).toInt().toString(),
      ...
      return {
        'playerImagePath':
            player['player_photo']?.isNotEmpty == true
                ? player['player_photo']
                : defaultImage,
